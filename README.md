...
> 当前状态：**M1 已收口（v0.2.x）**——注册登录 → 建笔记 → 编辑保存 → 多端同步的闭环已跑通，并在真实浏览器与线上实例验证过。下一步 M2（界面框架填充 → 笔记本/文件夹 → Memo → 待办 → 搜索 → 设置 → 首页）见 `docs/todo/Menote-M2-实施计划-v1.md`；M0–M6 路线图见 `docs/todo/Menote-开发计划-v1.md`。
...
| `docs/todo/` | 专项计划：一个功能/任务一份实施计划（当前：`Menote-M2-实施计划-v1.md`；M0–M6 路线图 `Menote-开发计划-v1.md`） |
